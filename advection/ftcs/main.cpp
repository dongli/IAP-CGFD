...
int main(int argc, const char *argv[])
{
    ...
    double dt, dx;
    string outputPattern = "ftcs.%3s.nc";
    ...
    dt = configManager.getValue("ftcs", "dt", 1.0);
    dx = configManager.getValue("ftcs", "dx", 0.01);
    outputPattern = configManager.getValue("ftcs", "output_pattern", outputPattern);
